...
function ProgramElectivePracticalClassForm() {
	...
	const courses = useFetchCourses('', "PROGRAM_ELECTIVE_PRACTICAL");
	...
	const handler = async () => {
		const body = {
			...
			scheduleId,
			studentGroupId,
			courseType: "PROGRAM_ELECTIVE_PRACTICAL"
		}
	...
	const fetchHandler = (query: string) => {
		return	useFetchClasses(scheduleId as string, query, studentGroupId as string, "PROGRAM_ELECTIVE_PRACTICAL") 
	};
...
export default ProgramElectivePracticalClassForm