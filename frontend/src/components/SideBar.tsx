...
import infrastructureIcon from '../assets/infrastucture.svg'
...
function SideBar() {
  ...
  return (
    <div className="absolute z-10 bg-white h-full px-2  py-2 w-fit border-r-2" >
        ...
        <SideBarItem title={'Schedule'} path={'/schedule'} isExpanded={isExpanded} icon={infrastructureIcon}/>
    </div>
  )
}
  ...
  return (
    <Link to={path}>
        <div className='flex items-center rounded my-4 p-1 cursor-pointer'>
            <div className={`bg-gray-200  p-2 flex justify-center items-center rounded-full hover:shadow-xl hover:bg-gray-300 `}>
