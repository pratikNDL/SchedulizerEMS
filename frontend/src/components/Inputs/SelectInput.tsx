...
function SelectInput({ handler , values, label}: SelectInputType) {
  return (
    <div className="flex flex-col" >
        ...
        <select onChange={(e) => handler(e)} className="outline-none mt-0.5 bg-transparent text-primary-text border-b-2 border-input-highlight/70  focus:border-input-highlight" >
